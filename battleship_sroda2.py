...
#(Back.CYAN) - ustala kolor
#  tła
#(Style.RESET.ALL) - resetuje style kolorowania
# os.system('clear') - czyści ekran
orientation = ['V', 'H']
ship_one = u"\u26F5"
...
def is_colliding(board):
    return board[ship_row][ship_col] == ship_one or board[ship_row1][ship_col] != " " or board[ship_row2][ship_col] != " "
...
def define_comp_tripleships(board):
    ...
    while i < 1:
        ...
        if is_colliding():
        # board[ship_row][ship_col] == ship_one or board[ship_row1][ship_col] != " " or board[ship_row2][ship_col] != " ":
            ship_row = random.randrange(2, 17, 2)
            ship_col = random.randrange(2, 17, 2)
